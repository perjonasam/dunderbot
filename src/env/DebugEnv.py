...
class DebugEnv(gym.Env):
    ...
    #def __init__(self, df, train_predict):
        ...
        self.obs_array_length = self.data_n_timesteps
    ...
    def _next_observation(self):
        ...
        # obs = np.random.uniform(low=-1.0, high=1.0)
        return obs
    ...
    def _take_action(self, action):
        ...
        #TEMP
        current_net_worth = np.random.uniform(low=5, high=20)
    ...
    def reset(self):
        ...
        # TEMP
        self.start_step = self.df.index.min() + config.data_params.ti_nan_timesteps
